    ...
    <div className={`app-shell theme-${theme}`}>
      ...
      <section className="home-hero">
        <div className="hero-split">
          ...
          <div className="hero-content">
            <div className="hero-badge">v1.1.0</div>
            <h1>
      ...
      <section id="download" className="home-section">
        ...
        <div className="download-grid">
          <a href="https://github.com/ziaurrehman931554/ZeeVault/releases/latest/download/ZeeVault-Setup-1.1.0.exe" className="download-card glass-panel" target="_blank" rel="noreferrer">
